...
$lang['changelog'] = '<ul>
<li>Version 1.0.0. October, 2021 - Modified for CMSMS 2.0 compatibility. Improvements for search functionality.</li>
...
To use this module you will need one, or more module calls in your template, or in one or more of your pages.  The first module call, like \'{cms_module module=Questions2 mode=form}\'; will display a form that allows any user to submit questions.  Another tag, something like \'{cms_module module=Questions2}\'; will display a list of previously answered and approved questions.  You may also need to provide further parameters to each of the calls, see the \'Parameters\' section for more information.
<h3>Support</h3>
